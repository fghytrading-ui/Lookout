...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-[#080808] text-[#e8e8e8]">
      ...
      {/* The measured edge used to be shouted here in red while the losing
          setups were still listed underneath. Warning about trades and then
          showing them anyway is the worst of both: it puts a losing system in
          front of you and asks you to overrule it. The board now simply does
          not offer them, and says so in one line where the cards would be.
          The full numbers stay in the "Is it working" panel below. */}
      {showSources && goals && (
        <div className="mx-4 mt-3 p-3 rounded border border-[#1a1a1a] bg-[#0a0a0a]">
